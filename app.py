...
def main():
    ...
    # navigation buttons – ONLY existing apps now
    ...
    # If profile is incomplete, just show a non-blocking warning on non-profile pages
    if not profile_complete and page != "Profile":
        st.info(
            "Your profile is not fully completed yet. "
            "For best results in the trainer and nutrition modules, "
            "please fill in all fields on the Profile page."
        )
...
# ---- FINAL CSS OVERRIDES (Buttons, Sidebar, Layout) ----
st.markdown(
    f"""
    <style>
